...
class CameraVoiceHelpPage extends StatelessWidget {
  const CameraVoiceHelpPage({super.key});
                  ...
                  Align(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildHelpSection(context, 'Give permission', [
                          '(give needed permissions to camera)',
                        ]),
