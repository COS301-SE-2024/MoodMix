...
class LogIn extends StatefulWidget {
  ...
  const LogIn({Key? key, required this.authService}) : super(key: key);
...
class _LogInState extends State<LogIn> {
  ...
  Future<void> _handleLogin() async {
    ...
    final result = await widget.authService
        .login(email: email, password: password); // Use widget.authService
  ...
  Future<void> _handleForgotPassword() async {
    ...
    if (email.isNotEmpty) {
      final result = await widget.authService
          .sendPasswordResetEmail(email); // Use widget.authService
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      resizeToAvoidBottomInset: false, // Allow resizing to avoid overflow
      body: SafeArea(
        child: _isLoading
            ? Center(
          ...
          children: <Widget>[
            Expanded( // Use Expanded to take available height
